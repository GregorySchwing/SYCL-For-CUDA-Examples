...
bool alternatingBFSTree(sycl::queue &q, 
                CSRGraph & g,
                int & matchCount,
  ...
  do{
...

      {
        ...
        // Instantly stop if a blossom is contracted.  
        // This is so the parallel state could be mapped to a serial state.
